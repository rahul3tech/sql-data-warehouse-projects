...
BEGIN
    ...
    CASE WHEN bdate > GETDATE() THEN NULL
        ELSE bdate
    END AS bdate,  -- St future birthdates to NULL
    CASE 
    ...
    CASE
        ...
        WHEN REPLACE(REPLACE(TRIM(maintenance), CHAR(13), ''), CHAR(10), '') = 'No' THEN 'No'
    END AS maintenance  --Normalization and Handling of missing or silimar data
